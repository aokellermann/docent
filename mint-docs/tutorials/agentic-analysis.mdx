...
- **Triaging before deep analysis**: Your agent can triage runs before engaging in analysis at scale, improving cost efficiency. Focus expensive analysis by prompting the agent to:
