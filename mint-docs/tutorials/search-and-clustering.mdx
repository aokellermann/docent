---
title: "Search and Clustering"
description: "Search for specific behaviors in agent runs and cluster results"
---
...
<Accordion title="How to get rubrics for the current Collection">
