...
description: "Configuration options for self-hosted Docent"
---
...
<Note>
You don't have to specify API keys for all providers; only ones that are used. See here for details on [adding new providers](/self-hosting/llm-providers#provider-registry) and [customizing Docent's LLM API calls](/self-hosting/llm-providers#selecting-models-for-docent-functions).
</Note>
