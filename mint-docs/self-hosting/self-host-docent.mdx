...
For most users, we recommend starting with the [public version](/get-started/quickstart) of Docent. We also provide white-glove hosting support for larger organizations; please [reach out](mailto:kevin@transluce.org?subject=Inquiry%20about%20Docent%20hosting) if you're interested.
...
You're all set! Check out our [quickstart](/get-started/quickstart) to get started.
