...
3. **SDK Ingestion**: Programmatically ingest transcripts using the Python SDK. We recommend using [our agent skill for ingestion](../agent-skills/ingestion) to write an ingestion script for you.
...
For detailed tracing documentation, see [Tracing Introduction](/get-started/tracing).
...
<Info>
We strongly recommend using our [Claude Code skill for ingestion](../agent-skills/ingestion), which uses best practices to write an ingestion script for your data. The following instructions are for writing the script by hand.
</Info>
