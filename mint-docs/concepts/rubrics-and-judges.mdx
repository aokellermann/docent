...
- `CONSTRAINED_DECODING`: Parse entire output as JSON (uses structured output). Supported by OpenAI and OpenRouter. Not yet implemented for Anthropic or Google (will raise `NotImplementedError`).
