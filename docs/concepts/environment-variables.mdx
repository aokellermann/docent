...
<Note>
You don't have to specify API keys for all providers; only ones that are used. See [here](/concepts/llm-prefs) for details on customizing LLM API calls used throughout Docent.
</Note>
