...
# from docent_core._ai_tools.refinement.refinement_old import (
#     format_conversation,
...
# from docent_core._server._dependencies.services import get_refinement_service_old
# from docent_core._server._dependencies.user import get_user_anonymous_ok
# from docent_core.services.refinement_old import RefinementServiceOld
...
#     collection_id: str,
#     rubric_id: str,
#     refinement_svc: RefinementServiceOld = Depends(get_refinement_service_old),
# ):
...
#             refinement_svc = RefinementServiceOld(session, db.session, mono_svc)
