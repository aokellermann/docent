...
import MinimalPaginatedResultsList from './MinimalPaginatedResultsList';
import { SchemaDefinition } from '@/app/types/schema';
import { Label } from '@/app/api/labelApi';
import { ViewMode } from '../../utils/viewModeResults';

interface MinimalJudgeResultsListProps {
...
export const MinimalJudgeResultsList = ({
  centroids,
  assignments,
  agentRunResults,
  labels,
  ...
  return (
    <MinimalPaginatedResultsList
      ...
      routeBase={routeBase}
      metadataByAgentRunId={metadataByAgentRunId}
    />
  );
};
